...
import { Department, DepartmentForm } from "../../../../../../types/Department"
import { useForm } from "react-hook-form";
import Router, { useRouter } from "next/router"
import createDepartmentForm from "../../../../../../components/admin/forms/departments/createEditForm"
import { NextPageContext } from "next"
import { mainUrl } from "../../../../../../api/url"
import CategoriesFunctions from "../../categories/categoriesFunctions"
...
EditDepartment.getInitialProps = async (ctx: NextPageContext) => {
    ...
    departmentJson = await getDepartmentToEdit(mainUrl + '/api/admin/departments/showEditDepartment', ctx)
