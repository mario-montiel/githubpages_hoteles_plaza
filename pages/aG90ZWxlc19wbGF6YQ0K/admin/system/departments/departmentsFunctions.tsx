...
const DepartmentsFunctions = () => {
    ...
    const successConfirm = async () => {
        ...
        try {
            await fetch(mainUrl + '/api/admin/departments/addDepartments', {
                headers: {
    ...
    const deleteDepartment = async () => {
        ...
        await fetch(mainUrl + '/api/admin/departments/removeDepartments', {
            method: 'POST',
            headers: {
                'Content-type': 'application/json'
            },
    ...
    const loadingData = (props: any) => {
        ...
        if (!props && !props.department) {
            router.replace(mainUrl + '/aG90ZWxlc19wbGF6YQ0K/admin/system/departments/departments')
    ...
    const successEditConfirm = async () => {
        ...
        setShowLoading({ ...showLoading, show: true })
        try {
            await fetch(mainUrl + '/api/admin/departments/editDepartments', {
                method: 'POST',
                headers: {
                    'Content-type': 'application/json'
                },
