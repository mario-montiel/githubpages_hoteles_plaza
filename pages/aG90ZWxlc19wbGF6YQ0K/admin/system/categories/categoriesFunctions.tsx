...
const CategoriesFunctions = () => {
    ...
    const successConfirm = async () => {
        ...
        try {
            await fetch(mainUrl + '/api/admin/categories/addCategories', {
                method: 'POST',
                headers: {
    ...
    const deleteCategory = async () => {
        ...
        await fetch(mainUrl + '/api/admin/categories/removeCategories', {
            method: 'POST',
            headers: {
                'Content-type': 'application/json'
            },
    ...
    const successEditConfirm = async () => {
        ...
        setShowLoading({ ...showLoading, show: true })
        try {
            await fetch(mainUrl + '/api/admin/categories/editCategories', {
                method: 'POST',
                headers: {
                    'Content-type': 'application/json'
                },
