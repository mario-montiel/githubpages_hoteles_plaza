...
import googleMaps from "./googleMapsFunctions"
import { NextPageContext } from "next"
import { mainUrl } from "../../../../../api/url"
import Router, { useRouter } from "next/router"
import HotelesFunctions from "./hotelsFunctions"
...
CreateHotel.getInitialProps = async (ctx: NextPageContext) => {
    ...
    categoriesJson = await getFetch(mainUrl + '/api/admin/categories/showCategories', ctx)
    roomsTypeJson = await getFetch(mainUrl + '/api/admin/rooms/roomsType/showRoomsType', ctx)
    roomsStatusJson = await getFetch(mainUrl + '/api/admin/rooms/roomsStatus/showRoomsStatus', ctx)
...
export default function CreateHotel(props: any) {
    ...
    }, [/* hotel.image, */ showGoogleMaps, dataOfPlace])
