...
EditHotel.getInitialProps = async (ctx: NextPageContext) => {
    ...
    categoriesJson = await getFetchData(mainUrl + '/api/admin/categories/showCategories', ctx)
    ...
    HotelJson = await getFetchData(mainUrl + '/api/admin/hotels/showEditHotel', ctx, ctx.query.id)
