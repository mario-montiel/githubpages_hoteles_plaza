...
const RoomFunctions = () => {
    ...
    const successConfirm = async (dataForm: RoomStatus) => {
        ...
        try {
            await fetch(mainUrl + '/api/admin/rooms/roomsStatus/addRoomsStatus', {
                method: 'POST',
                headers: {
    ...
    const deleteRoomStatus = async (dataForm: RoomStatus) => {
        ...
        await fetch(mainUrl + '/api/admin/rooms/roomsStatus/removeRoomsStatus', {
            method: 'POST',
            headers: {
                'Content-type': 'application/json'
            },
    ...
    const successEditConfirm = async (dataForm: RoomStatus) => {
        ...
        setShowLoading({ ...showLoading, show: true })
        try {
            await fetch(mainUrl + '/api/admin/rooms/roomsStatus/editRoomsStatus', {
                method: 'POST',
                headers: {
                    'Content-type': 'application/json'
                },
    ...
    const sentRequest = async (roomsData: any) => {
        ...
        await fetch(mainUrl + '/api/admin/rooms/addRooms', {
            method: 'POST',
            headers: {
                'Content-type': 'application/json'
            },
