...
EditCategory.getInitialProps = async (ctx: NextPageContext) => {
    ...
    rooomTypeJson = await getFetch(endpoint + '/api/admin/rooms/roomsType/showRoomsType', ctx)
    rooomJson = await getFetch(endpoint + '/api/admin/rooms/showEditRoom', ctx, ctx.query.id)
