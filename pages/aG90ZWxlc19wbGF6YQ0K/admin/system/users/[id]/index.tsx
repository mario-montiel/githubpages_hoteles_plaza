...
EditUser.getInitialProps = async (ctx: NextPageContext) => {
    ...
    departmentsJson = await getFetchData(mainUrl + '/api/admin/departments/showDepartments', ctx)
    typeUsersJson = await getFetchData(mainUrl + '/api/admin/users/showTypeUsers', ctx)
    hotelsJson = await getFetchData(mainUrl + '/api/admin/hotels/showHotels', ctx)
    userJson = await getFetchData(mainUrl + '/api/admin/users/showEditUser', ctx, ctx.query)
