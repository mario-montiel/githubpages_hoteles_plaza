...
const ReservationsFunctions = () => {
    ...
    const successConfirm = async (dataForm: RoomType) => {
        ...
        try {
            await fetch(mainUrl + '/api/admin/rooms/roomsType/addRoomsType', {
                method: 'POST',
                headers: {
    ...
    const deleteRoomType = async (dataForm: RoomType) => {
        ...
        await fetch(mainUrl + '/api/admin/rooms/roomsType/removeRoomsType', {
            method: 'POST',
            headers: {
                'Content-type': 'application/json'
            },
    ...
    const loadingData = (props: any) => {
        ...
        if (!props.roomType.res) {
            ...
            return router.replace(mainUrl + '/aG90ZWxlc19wbGF6YQ0K/admin/system/rooms/rooms_type/rooms_type')
    ...
    const successEditConfirm = async (dataForm: RoomType) => {
        ...
        setShowLoading({ ...showLoading, show: true })
        try {
            await fetch(mainUrl + '/api/admin/rooms/roomsType/editRoomsType', {
                method: 'POST',
                headers: {
                    'Content-type': 'application/json'
                },
...
export default ReservationsFunctions