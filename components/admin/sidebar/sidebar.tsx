            ...
            hotels && hotels.length > 0 ? (
                hotels.map((hotel: any, index: number) => {
                    html.push(
                        ...
                        >
                            {console.log(hotel)  }
                            <Image src={'/logos/' + hotel.hotel.pathImageName + 'logo.webp'} width={70} height={50} objectFit={'cover'} />
                        </li>
                    )
                })
            ) : (null)
            ...
            <ul className={styles.ul_sidebar_restaurant}>
                ...
                <ul className={dropwdown.dropdown3 && !dropwdown.sidebar ? styles.ul_sidebar_restaurant_dropdown_active : styles.ul_sidebar_restaurant_dropdown} >
                    ...
                    <li className={styles.li_sidebar_restaurant_dropdown}>
                        <div className={styles.chip} onClick={() => router.push(mainUrl + '/aG90ZWxlc19wbGF6YQ0K/admin/restaurant/rooms')}>
                            <p>Habitaciones</p>
                        </div>
                    </li>
                    <li className={styles.li_sidebar_restaurant_dropdown}>
