...
const UbicationContactDemo1 = ({ hotel, iFrameUrl }: any) => {
    ...
    return (
        <section className={styles.ubication_contact}>
            ...
            'el entronque de la Carretera Torreón – Saltillo, en Blvd. Matamoros Torreón 125 Nte. Fracc. Punta Laguna, Matamoros, Coah. México.'}
                </p>
            ...
            <div className={styles.ubication_container}>
                ...
                <iframe src={iFrameUrl} width="600" height="450" style={{border: 0}} loading="lazy"></iframe>
            </div>
