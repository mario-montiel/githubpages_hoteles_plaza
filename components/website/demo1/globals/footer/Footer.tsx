            ...
            <div className={styles.menu_container}>
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <Link href={currentHotel === 'matamoros' ? 'https://www.instagram.com/hotel.plaza.matamoros/?hl=es' : 'https://www.instagram.com/hotel_plaza_catedral/'}>
                        ...
                        <Link href={currentHotel === 'matamoros' ? 'https://www.facebook.com/HotelPlazaMatamoros/' : 'https://www.facebook.com/hotelplazacatedralGP/'}>
                            <svg className={styles.svg_social_media_icon} viewBox="0 0 24 24">
