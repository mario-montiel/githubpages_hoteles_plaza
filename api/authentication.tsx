...
export const Authenticated: any = (fn: NextApiHandler) => (req: NextApiRequest, res: NextApiResponse) => {
...
// export const AuthenticatedAdmin = (fn: NextApiHandler) => (req: NextApiRequest, res: NextApiResponse) => {
//     const authorization: string = req.cookies.auth || ''
